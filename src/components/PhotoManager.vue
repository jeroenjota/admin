<!-- PhotoManager.vue -->
<template>
  <div class="flex items-start justify-between gap-2 space-y-4">
    <!-- Foto grid -->
    <draggable
      v-model="photos"
      item-key="id"
    ...
    <!-- Upload + Library knop -->
    <div class="flex flex-col justify-between gap-4 sm:flex-col">
      ...
      <button
        class="rounded border bg-green-700 px-4 py-2 text-sm text-white hover:bg-green-900"
